...
### [1.12.10](https://github.com/impleotv/stserver-frontend-comp/compare/v1.12.9...v1.12.10) (2026-05-08)


### Bug Fixes

* Fix time format (24H) ([1e45b90](https://github.com/impleotv/stserver-frontend-comp/commit/1e45b906f97f182ba7d5f3fa83ed6423e2247177))

### [1.12.9](https://github.com/impleotv/stserver-frontend-comp/compare/v1.12.8...v1.12.9) (2026-02-04)

### [1.12.8](https://github.com/impleotv/stserver-frontend-comp/compare/v1.12.1...v1.12.8) (2026-02-04)
...
### [1.12.7](https://github.com/impleotv/stserver-frontend-comp/compare/v1.12.6...v1.12.7) (2025-12-11)
...
* Update Stanag2WebRtcPlayer ([7b8f313](https://github.com/impleotv/stserver-frontend-comp/commit/7b8f31394ba9764a54b3a90c2662c578de161046))
...
### [1.0.14](https://github.com/impleotv/stserver-frontend-comp/compare/v1.0.13...v1.0.14) (2021-11-09)
...
* Update dependencies ([8140d33](https://github.com/impleotv/stserver-frontend-comp/commit/8140d33dc6daf6a5b9ec6abb27ea59a5aab28114))
...
- update dependencies
## Ver. 0.2.37 (22/09/21)
- Fix reverse proxy webrtc player
## Ver. 0.2.35 (21/09/21)
- Fix js player url
## Ver. 0.2.32 (18/09/21)
- Update dependencies date-fns recharts video.js
## Ver. 0.2.31 (14/09/21)
- Table events update
## Ver. 0.2.29 (13/09/21)
- Sensors check 
...
## Ver. 0.2.27 (09/09/21)
- Add aoiMode report to mission table
## Ver. 0.2.24 (02/09/21)
- Upgrade storybook
- Table refresh on missionFilter change
## Ver. 0.2.23 (02/09/21)
- Add map
## Ver. 0.2.20 (31/08/21)
- Fix time selection
...
- Add tests
## Ver. 0.2.16 (26/08/21)
- Add events to MissionTable
## Ver. 0.2.15 (25/08/21)
- Update dependencies
- Fix MissionTable
## Ver. 0.2.8 (24/08/21)
- Add login control
- Add register control
## Ver. 0.2.7 (18/08/21)
- Update dependencies
- Modify license update
## Ver. 0.2.6 (09/08/21)
- Update dependencies
- Modify license error presentation
## Ver. 0.2.5 (09/08/21)
- Update dependencies
## Ver. 0.2.3 (20/07/21)
- Mission table improvements
## Ver. 0.2.3 (19/07/21)
- Add mission table
## Ver. 0.2.2 (04/07/21)
- Fix live offline 
...
- Update dependencies
## Ver. 0.1.54 (16/05/21)
- Add useLicenseInfo and StLicenseInfo
- Update dependencies

## Ver. 0.1.53 (05/05/21)
- Update dependencies
- useSensorBookmarks update 
## Ver. 0.1.52 (03/05/21)
- Update dependencies
## Ver. 0.1.51 (28/04/21)
...
## Ver. 0.1.46 (19/04/21)
- Expose internal videojs via ref
- Fix bookmark update time
## Ver. 0.1.42 (15/04/21)
- Fix live mode with reverse proxy
- Add events
## Ver. 0.1.33 (11/04/21)
- Add live mode
## Ver. 0.1.28 (10/04/21)
...
- Update dependencies
## Ver. 0.1.22 (29/03/21)
- Add StreamPresent (in sensors) to MissionTimeline
## Ver. 0.1.21 (25/03/21)
- Add curTime to MissionTimeline
## Ver. 0.1.19 (22/03/21)
- Bookmark's tooltip offset
- Update dependencies
## Ver. 0.1.18 (21/03/21)
- Timeline controls (SensorTimeline, MissionTimeline, StMissionTimeline)
- Update dependencies
## Ver. 0.1.17 (18/03/21)
- Timeline controls (SensorTimeline, MissionTimeline, StMissionTimeline)
- Update dependencies
...
## Ver. 0.1.15
- Fixes
- Make Material-UI a peer dependency (@material-ui/core, @material-ui/icons, @material-ui/lab) 
## Ver. 0.1.14
- Add StBookmarksTimeline component
## Ver. 0.1.13
- Add bookmark form component
## Ver. 0.1.11
- Add bookmark timeline component
## Ver. 0.1.7
- Add components
## Ver. 0.1.6
- Fix responsive container 
## Ver. 0.1.5
- Fix responsive crosshair 
## Ver. 0.1.4
- Export HlsPlayer and  KlvView 
