...
|:---------|:-------------------:|:------------------------------------------------------------------------|
| **StServer (Linux x64)** |  3.5.2 | [stserver-install.tar.gz](https://github.com/impleotv/stserver-release/releases/download/v3.5.2/stserver-install.tar.gz)  | 
| **StServer (VOD for WSL2)** |  3.5.2 | [stserver-install-wsl.tar.gz](https://github.com/impleotv/stserver-release/releases/download/v3.5.2/stserver-install-wsl.tar.gz)  | 

*Released on Tue, 16 Jun 2026, 17:14 GMT+3*


Download stserver-install.tar.gz
```
wget https://github.com/impleotv/stserver-release/releases/download/v3.5.2/stserver-install.tar.gz
...
|                  | Version             | CHANGELOG                                                          | 
|:-----------------|:-------------------:|:------------------------------------------------------------------------|
| **Backend**      |  3.5.2 | [CHANGELOG-SERVER.md](./CHANGELOG-SERVER.md) | 
| **Frontend**     |  3.2.4 | [CHANGELOG-FRONTEND.md](./CHANGELOG-FRONTEND.md) | 
| **FrontendComp** |  1.12.10 | [CHANGELOG-FRONTEND-COMP.md](./CHANGELOG-FRONTEND-COMP.md) | 
