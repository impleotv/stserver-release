...
|:---------|:-------------------:|:------------------------------------------------------------------------|
| **StServer (Linux x64)** |  3.3.2 | [stserver-install.tar.gz](https://github.com/impleotv/stserver-release/releases/download/v3.3.2/stserver-install.tar.gz)  | 
| **StServer (VOD for WSL2)** |  3.3.2 | [stserver-install-wsl.tar.gz](https://github.com/impleotv/stserver-release/releases/download/v3.3.2/stserver-install-wsl.tar.gz)  | 

*Released on Sun, 10 May 2026, 09:59 GMT+3*


Download stserver-install.tar.gz
```
wget https://github.com/impleotv/stserver-release/releases/download/v3.3.2/stserver-install.tar.gz
...
|                  | Version             | CHANGELOG                                                          | 
|:-----------------|:-------------------:|:------------------------------------------------------------------------|
| **Backend**      |  3.3.2 | [CHANGELOG-SERVER.md](./CHANGELOG-SERVER.md) | 
| **Frontend**     |  3.2.2 | [CHANGELOG-FRONTEND.md](./CHANGELOG-FRONTEND.md) | 
