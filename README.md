...
|:---------|:-------------------:|:------------------------------------------------------------------------|
| **StServer (Linux x64)** |  2.2.24 | [stserver-install.tar.gz](https://github.com/impleotv/stserver-release/releases/download/v2.2.24/stserver-install.tar.gz)  | 
| **StServer (VOD for WSL2)** |  2.2.24 | [stserver-install-wsl.tar.gz](https://github.com/impleotv/stserver-release/releases/download/v2.2.24/stserver-install-wsl.tar.gz)  | 

*Released on Fri, 29 Apr, 17:42 GMT+3*
...
|                  | Version             | CHANGELOG                                                          | 
|:-----------------|:-------------------:|:------------------------------------------------------------------------|
| **Backend**      |  2.2.24 | [CHANGELOG-SERVER.md](./CHANGELOG-FRONTEND.md) | 
| **Frontend**     |  2.1.45 | [CHANGELOG-FRONTEND.md](./CHANGELOG-FRONTEND.md) | 
| **FrontendComp** |  1.2.25 | [CHANGELOG-FRONTEND-COMP.md](./CHANGELOG-FRONTEND-COMP.md) | 
