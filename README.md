...
| **StServer (VOD for WSL2)** |  2.2.22 | [stserver-install-wsl.tar.gz](https://github.com/impleotv/stserver-release/releases/download/v2.2.22/stserver-install-wsl.tar.gz)  | 

*Released on Tue, 26 Apr, 12:00 GMT+3*
