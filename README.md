...
|:---------|:-------------------:|:------------------------------------------------------------------------|
| **StServer (Linux x64)** |  2.9.2 | [stserver-install.tar.gz](https://github.com/impleotv/stserver-release/releases/download/v2.9.2/stserver-install.tar.gz)  | 
| **StServer (VOD for WSL2)** |  2.9.2 | [stserver-install-wsl.tar.gz](https://github.com/impleotv/stserver-release/releases/download/v2.9.2/stserver-install-wsl.tar.gz)  | 

*Released on Thu, 5 Oct, 18:14 GMT+3*
...
|                  | Version             | CHANGELOG                                                          | 
|:-----------------|:-------------------:|:------------------------------------------------------------------------|
| **Backend**      |  2.9.2 | [CHANGELOG-SERVER.md](./CHANGELOG-SERVER.md) | 
| **Frontend**     |  2.7.1 | [CHANGELOG-FRONTEND.md](./CHANGELOG-FRONTEND.md) | 
| **FrontendComp** |  1.8.3 | [CHANGELOG-FRONTEND-COMP.md](./CHANGELOG-FRONTEND-COMP.md) | 
...
## Known issues for version 2.9.2
