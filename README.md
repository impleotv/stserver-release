...
|:---------|:-------------------:|:------------------------------------------------------------------------|
| **StServer (Linux x64)** |  2.5.1 | [stserver-install.tar.gz](https://github.com/impleotv/stserver-release/releases/download/v2.5.1/stserver-install.tar.gz)  | 
| **StServer (VOD for WSL2)** |  2.5.1 | [stserver-install-wsl.tar.gz](https://github.com/impleotv/stserver-release/releases/download/v2.5.1/stserver-install-wsl.tar.gz)  | 

*Released on Mon, 13 Mar, 10:54 GMT+2*
...
|                  | Version             | CHANGELOG                                                          | 
|:-----------------|:-------------------:|:------------------------------------------------------------------------|
| **Backend**      |  2.5.1 | [CHANGELOG-SERVER.md](./CHANGELOG-FRONTEND.md) | 
...
## Known issues for version 2.5.1
